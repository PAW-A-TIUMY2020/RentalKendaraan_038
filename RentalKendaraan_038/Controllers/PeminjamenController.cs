...
using RentalKendaraan_038.Models;

namespace RentalKendaraan_038.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        {
            var rental_KendaraanContext = _context.Peminjaman.Include(p => p.IdJaminanNavigation).Include(p => p.IdPeminjaman1).Include(p => p.IdPeminjamanNavigation);
